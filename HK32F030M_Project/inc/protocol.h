...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "fq7yixtj3zrmrwx6"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//手动喂食(可下发可上报)
//备注:该DP的所能支持的最大值是100，实际使用场景一般在25以内，建议不要设置大，会直接影响面板体验。
...
//余粮状态(只上报)
//备注:
#define DPID_STATUS 6
//粮桶余粮(可下发可上报)
//备注:
#define DPID_GRAIN_SURPLUS 7
//余粮百分比(只上报)
//备注:
#define DPID_PERCENT_STATE 8
//出粮校准状态(只上报)
//备注:
#define DPID_EXPORT_STATE 9
//电池电量(只上报)
//备注:
#define DPID_BATTERY_PERCENTAGE 10
//充电状态(只上报)
//备注:
#define DPID_CHARGE_STATE 11
//喂食盖状态(只上报)
//备注:
#define DPID_COVER_STATE 12
//故障告警(只上报)
//备注:
#define DPID_FAULT 13
//喂食结果上报(只上报)
//备注:
#define DPID_FEED_REPORT 14
//余粮重量(只上报)
//备注:
#define DPID_WEIGHT 15
//语音播放次数(可下发可上报)
//备注:
#define DPID_VOICE_TIMES 16
//小夜灯(可下发可上报)
//备注:
#define DPID_LIGHT 17
//彩光调节(可下发可上报)
//备注:1.色度：4个字符，标识：H	
//数值范围：0~360，0X0000~0X0168
//2.饱和度：4个字符，标识：S；数值范围：0~1000, 0X0000~0X03E8
//3.明度：4个字符，标识: V;数值范围：0~1000，0X0000~0X03E8
#define DPID_COLOUR_DATA 18
//单位转换(可下发可上报)
//备注:
#define DPID_UNIT_SWITCH 22
//慢放喂食(可下发可上报)
//备注:
#define DPID_SLOW_FEED 23
//恢复出厂(可下发可上报)
//备注:
#define DPID_FACTORY_RESET 24
//开关(可下发可上报)
//备注:
#define DPID_SWITCH 25
//余粮校准(可下发可上报)
//备注:
#define DPID_WEIGHT_CALIBRATE 26
